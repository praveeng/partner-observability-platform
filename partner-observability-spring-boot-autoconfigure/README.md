...
- Micrometer hooks use configured API IDs and opaque partner slots only; the Actuator health contributor reports bounded dispatcher state and never backend readiness or secret/config values.
